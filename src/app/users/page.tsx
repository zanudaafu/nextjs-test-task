...
export default function UsersPage() {
    const { users, page, total, pageSize, totalPages, isLoading, setPage, deleteUser, loadPage, createUser, editUser } = useUsersTable()

    return (
        <div className="p-6 space-y-4">
            <h1 className="text-2xl font-bold max-w-6xl mx-auto">Users</h1>
            <div className="max-w-6xl mx-auto">
                <UsersTableHeader loadPage={loadPage} createUser={createUser}/>
            </div>
